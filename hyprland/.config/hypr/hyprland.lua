...
local fileManagerUI = "thunar"
local browser = "firefox"
local menu = "fuzzel --config ~/.config/fuzzel/fuzzel.ini --counter"
...
local active_color = "rgba(dbb84467)"
local inactive_color = "rgba(ddb44967)"
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { active_color, "rgba(00ff99ee)" }, angle = 45 },
...
-- Screenshots
hl.bind(mainMod .. " + PRINT", hl.dsp.exec_cmd("hyprshot -m region -z --clipboard-only"))
hl.bind(mainMod .. " + SHIFT + PRINT", hl.dsp.exec_cmd("hyprshot -m region -o ~/Pictures"))
...
hl.define_submap("resize", function()
	...
	hl.bind(mainMod .. " + SHIFT + T", hl.dsp.submap("reset"))
end)
...
hl.bind(mainMod .. " + Q", hl.dsp.workspace.toggle_special("Q"))
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.window.move({ workspace = "special:Q" }))
hl.bind(mainMod .. " + W", hl.dsp.workspace.toggle_special("W"))
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.window.move({ workspace = "special:W" }))
hl.bind(mainMod .. " + E", hl.dsp.workspace.toggle_special("E"))
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.window.move({ workspace = "special:E" }))
hl.bind(mainMod .. " + R", hl.dsp.workspace.toggle_special("R"))
hl.bind(mainMod .. " + SHIFT + R", hl.dsp.window.move({ workspace = "special:R" }))
